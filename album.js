...
function delete_foto(event){
  const str="delete_foto.php?id="+encodeURIComponent(event.currentTarget.id);
  console.log(str);
  fetch(str).then(window.location.replace("album.php"));
...
function onJSON(json){
  ...
  fetch("foto.php").then(onResponse).then(onJSON);
