<html>
    ...
    <body>
        ...
        <section class="s1">
			...
			<form action="upload.php" method="POST" enctype="multipart/form-data"> <!-- enctype serve per permettere di inviare file dal form  -->	
            <?php
                $db=ConnessioneDB();
            ...
            ?>
                ...
                <div class="dati_upload">
					...
					<br><br>
					<a href="account.php" class="link">Torna a gestisci account</a>
                </div>
            </form>
